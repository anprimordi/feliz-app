...
import com.feliz.apps.databinding.FragmentEditCateringBinding
...
class EditCateringFragment : Fragment(), EditCateringContract.View {
    private lateinit var binding: FragmentEditCateringBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEditCateringBinding.inflate(inflater)
        ...
        viewModel.cateringListObservable.observe(viewLifecycleOwner) { list ->
            showCateringList(list)
        }

        return binding.root
    }

    override fun showCateringList(list: ArrayList<Pair<String, String>>) {
    ...
    override fun addElement(data: Pair<String, String>) {
        viewModel.addElementCatering(data)
    }

    override fun deleteElement(data: Pair<String, String>) {
        viewModel.deleteElementCatering(data)
    }
}