...
import com.feliz.apps.databinding.FragmentEditDocumentationBinding
...
class EditDocumentationFragment : Fragment(), EditDocumentationContract.View {
    private lateinit var binding: FragmentEditDocumentationBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEditDocumentationBinding.inflate(inflater)
        ...
        viewModel.documentationListObservable.observe(viewLifecycleOwner) { list ->
            showDocumentationList(list)
        }

        return binding.root
    }

    override fun showDocumentationList(list: ArrayList<Pair<String, String>>) {
    ...
    override fun addElement(data: Pair<String, String>) {
        viewModel.addElementDocumentation(data)
    }

    override fun deleteElement(data: Pair<String, String>) {
        viewModel.deleteElementDocumentation(data)
    }
}