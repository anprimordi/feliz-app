...
import com.feliz.apps.databinding.FragmentEditEntertainBinding
...
class EditEntertainFragment : Fragment(), EditEntertainContract.View {
    private lateinit var binding: FragmentEditEntertainBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEditEntertainBinding.inflate(inflater)
        ...
        viewModel.entertainListObservable.observe(viewLifecycleOwner) { list ->
            showEntertainList(list)
        }

        return binding.root
    }

    override fun showEntertainList(list: ArrayList<Pair<String, String>>) {
    ...
    override fun addElement(data: Pair<String, String>) {
        viewModel.addElementEntertain(data)
    }

    override fun deleteElement(data: Pair<String, String>) {
        viewModel.deleteElementEntertain(data)
    }
}