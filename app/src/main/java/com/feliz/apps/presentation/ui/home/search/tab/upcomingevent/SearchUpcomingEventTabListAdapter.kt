...
import com.feliz.apps.presentation.ui.home.search.tab.upcomingevent.SearchUpcomingEventTabListAdapter.ViewHolder

class SearchUpcomingEventTabListAdapter(val actionClicked: (item: Portfolio) -> Unit) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        /*val dateLong = Date(item.dateTime)
        val format = SimpleDateFormat("dd MMM", Locale.getDefault())
        val date = format.format(dateLong)*/
