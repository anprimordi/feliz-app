...
import com.feliz.apps.databinding.FragmentEditMcBinding
...
class EditMcFragment : Fragment(), EditMcContract.View {
    private lateinit var binding: FragmentEditMcBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEditMcBinding.inflate(inflater)
        ...
        viewModel.mcVendorListObservable.observe(viewLifecycleOwner) { list -> showMcList(list) }

        return binding.root
    }

    override fun showMcList(list: ArrayList<Pair<String, String>>) {
    ...
    override fun addElement(data: Pair<String, String>) {
        viewModel.addElementMc(data)
    }

    override fun deleteElement(data: Pair<String, String>) {
        viewModel.deleteElementMc(data)
    }
}