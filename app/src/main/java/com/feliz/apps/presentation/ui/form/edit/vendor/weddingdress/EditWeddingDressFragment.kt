...
import com.feliz.apps.databinding.FragmentEditWeddingDressBinding
...
class EditWeddingDressFragment : Fragment(), EditWeddingDressContract.View {
    private lateinit var binding: FragmentEditWeddingDressBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEditWeddingDressBinding.inflate(inflater)
        ...
        viewModel.weddingDressListObservable.observe(viewLifecycleOwner) { list ->
            showWeddingDressList(list)
        }

        return binding.root
    }

    override fun showWeddingDressList(list: ArrayList<Pair<String, String>>) {
    ...
    override fun addElement(data: Pair<String, String>) {
        viewModel.addElementWeddingDress(data)
    }

    override fun deleteElement(data: Pair<String, String>) {
        viewModel.deleteElementWeddingDress(data)
    }
}