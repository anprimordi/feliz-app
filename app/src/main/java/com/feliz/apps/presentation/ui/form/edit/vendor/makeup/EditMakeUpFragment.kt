...
import com.feliz.apps.databinding.FragmentEditMakeUpBinding
...
class EditMakeUpFragment : Fragment(), EditMakeUpContract.View {
    private lateinit var binding: FragmentEditMakeUpBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEditMakeUpBinding.inflate(inflater)
        ...
        viewModel.makeUpListObservable.observe(viewLifecycleOwner) { list -> showMakeUpList(list) }

        return binding.root
    }

    override fun showMakeUpList(list: ArrayList<Pair<String, String>>) {
    ...
    override fun addElement(data: Pair<String, String>) {
        viewModel.addElementMakeUp(data)
    }

    override fun deleteElement(data: Pair<String, String>) {
        viewModel.deleteElementMakeUp(data)
    }
}