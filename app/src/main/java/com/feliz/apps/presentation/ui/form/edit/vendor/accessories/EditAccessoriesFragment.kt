...
import com.feliz.apps.databinding.FragmentEditAccessoriesBinding
...
class EditAccessoriesFragment : Fragment(), EditAccessoriesContract.View {
    private lateinit var binding: FragmentEditAccessoriesBinding
    private val viewModel: FormEditViewModel by activityViewModels {
        VMProvider.formEdit(
            requireContext()
        )
    }
    private val adapter = FormEditAdapter { data ->
        deleteElement(data)
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentEditAccessoriesBinding.inflate(inflater)
        ...
        viewModel.accessoriesListObservable.observe(viewLifecycleOwner) {
            showAccessoriesList(it)
        }

        return binding.root
    }

    override fun showAccessoriesList(list: ArrayList<Pair<String, String>>) {
    ...
    override fun addElement(data: Pair<String, String>) {
        viewModel.addElementAccessories(data)
    }

    override fun deleteElement(data: Pair<String, String>) {
        viewModel.deleteElementAccessories(data)
    }
}